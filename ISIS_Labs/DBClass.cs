...
namespace ISIS_Labs
{
    class DBClass
    {
        ...
        {
            string conStr = @"Data Source=DESKTOP-BU4QHD1;Initial Catalog=ISISDB;Integrated Security=True";
        ...
        public bool Auth(string logo, string pass)
        {
            ...
            try
            {
                SqlCommand enterDBID = new SqlCommand("select password from Users where login = @Login and password = @Password", sqlConnection);
